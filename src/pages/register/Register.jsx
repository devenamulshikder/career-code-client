      ...
      <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg lg:max-w-4xl">
        ...
        <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
          <div className="flex justify-center mx-auto">
            <img
              //   className="w-auto md:w-12 md:h-16 sm:h-8"
       ...
       <form onSubmit={handleSubmit}>
              ...
              <div className="mt-6">
                <button
                type="submit"
                  className="w-full cursor-pointer px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform rounded-lg focus:outline-none focus:ring focus:ring-[#3282B8] focus:ring-opacity-50"
                  style={{
                    background: "linear-gradient(to right, #3282B8, #0F4C75)",
                  }}
                >
